...
<?php
    ...
    // Select our data
    $sql = "SELECT date_visit, l_name, f_name, company, profession, contact, v_object, obersation FROM Visitor";

    $result = $mysqli->query($sql);
?>
<center><h1> Tous les visiteurs  </h1>
<br>
...
<hr>
<br>
<a href="selallvi.php"><input type="submit" value="Acutalisez"></a>
                </div>
            </div>
        </div>
    </div>
